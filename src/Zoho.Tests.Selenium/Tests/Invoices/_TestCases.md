...
- Enter text in the "Customer Notes" field (e.g. "Please come again!")
- Click the "Save as Draft" button  
...
- Click on the "+New" button
- Select the "Use Simplified View" radio button
- Choose a customer from the "Customer Name" drop-down menu (e.g. "Nilsson, Carl")
- Choose an item from the drop-down menu, by clicking in the "Item Details" text field (e.g. "Acceptance Testing Services, Rate:$500.00")
- Enter text in the "Terms & Conditions" field (e.g. "Invoice and purchase details must remain confidential.")
- Click the "Save as Draft" button  
